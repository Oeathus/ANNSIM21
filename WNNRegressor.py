...
wnnrModelPath = "models" + os.path.sep + "regressor" + os.path.sep + "wnn" + os.path.sep

datasets = os.listdir(data_folder)

wnnr_log_csv_file = "logs" + os.path.sep + "regressor" + os.path.sep + "wnn.log.csv"
wnnr_log_file = "logs" + os.path.sep + "regressor" + os.path.sep + "wnn.log"
...
if not os.path.exists(wnnr_log_csv_file):
    log_file = open(wnnr_log_csv_file, 'w')
    log_file.close()
...
for dataset in datasets:
    ...
    for random_state in random_states:
        ...
        name = dataset_name + "," + str(random_state)

        model_folder = wnnrModelPath + name
        ...
        regressor = tf.estimator.LinearRegressor(feature_columns=feature_cols, model_dir=model_folder)
        ...
        with open(wnnr_log_csv_file, 'a') as log_file:
            log_file.write(name + "," +
                           str(r_squared) + "," +
                           str(skMSE) + "," +
                           str(skRMSE) + "," +
                           ...
                           str(finish_time) + "\n")
            log_file.close()
        print(name + " => " + str(r_squared) + ", " + str(skMSE) + ", " + str(skRMSE) + ", " + str(sciPearson) +
              "\nFinished " + name + " in " + str(finish_time))
