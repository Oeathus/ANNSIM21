...
dwnnModelPath = "models" + os.path.sep + "regressor" + os.path.sep + "dwnn" + os.path.sep
...
dwnnr_log_csv_file = "logs" + os.path.sep + "regressor" + os.path.sep + "dwnn.log.csv"
...
if not os.path.exists(dwnnr_log_csv_file):
    log_file = open(dwnnr_log_csv_file, 'w')
    log_file.close()
...
for dataset in datasets:
    ...
    for layer_count in layers:
        for random_state in random_states:
            ...
            model_folder = dwnnModelPath + name
            ...
            regressor = tf.estimator.DNNLinearCombinedRegressor(linear_feature_columns=feature_cols,
            ...
            with open(dwnnr_log_csv_file, 'a') as log_file:
                log_file.write(name + "," +
                               str(r_squared) + "," +
                               str(skMSE) + "," +
                               str(skRMSE) + "," +
